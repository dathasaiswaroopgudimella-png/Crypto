    ...
    <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: 24, animation: "fadeIn 0.3s ease" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>Registered Entities</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
          {filteredVasps.map(vasp => (
            <div
              ...
              onMouseLeave={(e) => e.currentTarget.style.borderColor = "#1a2742"}
            >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, borderTop: "1px solid #1a2742", paddingTop: 10 }}>
                <div>
                  <div style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>FIU Registration No.</div>
                  <div style={{ fontFamily: "monospace", fontSize: 12, color: "#10b981", fontWeight: 600 }}>
                    {vasp.fiuRegistrationNumber || "N/A (Offshore Entity)"}
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>Jurisdiction</div>
                  <div style={{ fontSize: 12, color: "#cbd5e1" }}>{vasp.jurisdiction}</div>
                </div>
              </div>

              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                <div>
                  <div style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>Compliance Nodal Desk</div>
                  <div style={{ fontSize: 12, color: "#38bdf8", display: "flex", alignItems: "center", gap: 4 }}>
                    <Mail size={11} /> {vasp.complianceEmail}
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>LEA Freeze Channel</div>
              ...
              {vasp.hotWallets.length > 0 && (
                <div style={{ borderTop: "1px solid #1a2742", paddingTop: 10 }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    {vasp.hotWallets.slice(0, 4).map(hw => (
                      <div
                        ...
                        onMouseLeave={(e) => e.currentTarget.style.borderColor = "#1a2742"}
                      >
                        <span style={{ fontSize: 10, color: hw.network === "ETH" ? "#38bdf8" : hw.network === "TRON" ? "#ef4444" : "#f59e0b", fontWeight: 700 }}>
                          {hw.network}
                        </span>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid #1a2742", paddingTop: 10 }}>
                <span style={{ fontSize: 12, color: "#94a3b8" }}>Click card for Full Dossier</span>
            ...
            {KNOWN_BRIDGE_CONTRACTS.map(b => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                  ...
                  <span style={{ fontSize: 10, padding: "2px 6px", borderRadius: 4, background: "rgba(6,182,212,0.15)", color: "#22d3ee", fontWeight: 700 }}>
                    {b.network}
                  </span>
                </div>
            ...
            {KNOWN_HIGH_RISK_ENTITIES.map(e => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
                  ...
                  {e.ofacSanctioned && (
                    <span style={{ fontSize: 10, padding: "2px 6px", borderRadius: 4, background: "rgba(239,68,68,0.2)", color: "#fca5a5", fontWeight: 800 }}>
                      OFAC SDN
                    </span>
                  )}
                </div>
                <div style={{ fontFamily: "monospace", fontSize: 10, color: "#94a3b8", marginBottom: 6 }}>
                  {e.address.slice(0, 14)}...{e.address.slice(-6)}
                </div>
                <div style={{ fontSize: 12, color: "#94a3b8", marginBottom: 10 }}>{e.description}</div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
                  <button
                    suppressHydrationWarning
                    onClick={(ev) => {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: "right" }}>
                <div style={{ fontSize: 10, color: "#94a3b8" }}>FIU REGISTRATION NO.</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div style={{ background: "#0b1226", padding: "12px", borderRadius: 8, border: "1px solid #1a2742" }}>
                <div style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>Jurisdiction / Registered Office</div>
                <div style={{ fontSize: 12, color: "#cbd5e1", marginTop: 4 }}>{selectedVasp.jurisdiction}</div>
              </div>
              <div style={{ background: "#0b1226", padding: "12px", borderRadius: 8, border: "1px solid #1a2742" }}>
                <div style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700 }}>Compliance Officer / Desk</div>
                ...
                {selectedVasp.hotWallets.map(hw => (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <span style={{ fontSize: 10, color: "#94a3b8" }}>({hw.type.replace("VASP_", "")})</span>
                    </div>
            ...
            {/* Actions Footer */}
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid #1a2742", paddingTop: 14 }}>
              <button
                suppressHydrationWarning
                onClick={() => {
      ...
      {selectedBridge && (
        <div style={{
          ...
          <div style={{
            background: "#0b1226", border: "1px solid #1e2c4a", borderRadius: 12,
            width: "100%", maxWidth: 540, padding: 24, display: "flex", flexDirection: "column", gap: 16,
            boxShadow: "0 0 30px rgba(14, 165, 233, 0.2)",
          }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <Shuffle size={20} color="#0ea5e9" />
                <div style={{ fontSize: 16, fontWeight: 800, color: "#f8fafc" }}>{selectedBridge.name}</div>
              </div>
              <button
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", borderTop: "1px solid #1e2c4a", paddingTop: 14 }}>
              <button
                onClick={() => handleCopy(selectedBridge.address)}
                style={{ background: "#060b18", border: "1px solid #334155", borderRadius: 8, padding: "8px 14px", fontSize: 12, color: "#cbd5e1", cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}
              >
                {copiedAddr === selectedBridge.address ? <Check size={13} color="#10b981" /> : <Copy size={13} />} Copy Router Address
              </button>
              <button
                onClick={() => {
                  handleTrace(selectedBridge.address, selectedBridge.network);
                  setSelectedBridge(null);
                }}
                style={{ background: "linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%)", border: "none", borderRadius: 8, padding: "8px 16px", fontSize: 12, fontWeight: 700, color: "white", cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}
              >
                Trace Bridge Router <ArrowRight size={13} />
              </button>
            </div>
          </div>
        </div>
      ...
      {selectedMixer && (
        <div style={{
          ...
          <div style={{
            background: "#0b1226", border: "1px solid #ff3366", borderRadius: 12,
            width: "100%", maxWidth: 540, padding: 24, display: "flex", flexDirection: "column", gap: 16,
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  <div style={{ fontSize: 16, fontWeight: 800, color: "#f8fafc" }}>{selectedMixer.name}</div>
                  <div style={{ fontSize: 12, color: "#ff3366", fontWeight: 700 }}>OFAC SDN Sanctioned Entity</div>
                </div>
              </div>
              <button
            ...
            <div style={{ background: "rgba(255, 51, 102, 0.08)", padding: 14, borderRadius: 8, border: "1px solid rgba(255, 51, 102, 0.25)" }}>
              <div style={{ fontSize: 12, color: "#fca5a5", lineHeight: 1.5 }}>{selectedMixer.description}</div>
              <div style={{ fontSize: 12, color: "#94a3b8", textTransform: "uppercase", fontWeight: 700, marginTop: 10, marginBottom: 4 }}>Smart Contract Address</div>
              <div style={{ fontFamily: "monospace", fontSize: 12, color: "#f8fafc", wordBreak: "break-all" }}>{selectedMixer.address}</div>
            </div>

            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", borderTop: "1px solid #1e2c4a", paddingTop: 14 }}>
              <button
                onClick={() => handleCopy(selectedMixer.address)}
                style={{ background: "#060b18", border: "1px solid #334155", borderRadius: 8, padding: "8px 14px", fontSize: 12, color: "#cbd5e1", cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}
              >
                {copiedAddr === selectedMixer.address ? <Check size={13} color="#10b981" /> : <Copy size={13} />} Copy Address
              </button>
              <button
                onClick={() => {
                  handleTrace(selectedMixer.address, selectedMixer.network);
                  setSelectedMixer(null);
                }}
                style={{ background: "linear-gradient(135deg, #ff3366 0%, #b91c1c 100%)", border: "none", borderRadius: 8, padding: "8px 16px", fontSize: 12, fontWeight: 700, color: "white", cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}
              >
                Trace Sanctioned Mixer <ArrowRight size={13} />
              </button>
            </div>
          </div>
        </div>
